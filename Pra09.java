...
class Test{
	...
	// - new Test()객체를 생성 하지 않고 클래스이름으로 바로 접근 가능한 변수 
...
public class Test70 {
	public static void main(String[] args) {
		//1.클래스 변수 y에 접근 하여 출력하기
		//방법 : 객체 생성 없이 클래스명.클래스변수명
		System.out.println("클래스명.클래스변수명 = " + Test.y );
		
		//2.인스턴스 변수 x를 객체 생성 없이 클래스명.인스턴스변수명으로 
		// 접근가능? 불가능
		//System.out.println("클래스명.인스텅스변수명 = " + Test.x);
		
		//3.인스턴스 변수 x에 접근 하여 출력하기 위해
		//new Test(10);객체 생성 하자 
		Test t1 = new Test(10);
		System.out.println("Test t1객체");
		//인스턴스 변수 x에 접근 하여 x변수값을 얻는 방법
		//참조변수명.인스턴스변수명
		System.out.println(t1.x);
		//클래스 변수 y에 접근 하여 y변수값을 얻는 방법
		//참조변수명.클래스변수명
	...
	//	System.out.println(t3.y);
		...
		/*
			...
			1. 객체 단위로 메모리할당하는 인스턴스변수(객체변수)는
			   ...
			   할당 하기 때문에  개별적인 인스턴스변수로 10이 각각 저장됨
