...
/*
 	FruiteSeller(과일장수) 클래스 내부 수정
 	1. 사과 한개당 가격을 저장할 APPLE_PRRICE변수에 final을 붙이자.
 	2. 추가한 initMembers 메소드 삭제.
 	3. 판매수익, 사과보유 개수, 사과 한개당 가격을 변수에 저장시킬 생성자 추가.
...
//JVM은 기본생성자를 만들어 놓지 않기 때문에, 직접 개발자가 기본생성자를 만들어 놓아야한다.
...
//생성자
	...
	//간단하게 생성자 만들기 (메뉴-소스-컨스트럭터 유징 필드)
	...
	public FruitSeller(int apple_price, int numApple, int myMoneys) {
		...
		myMoney = myMoneys; //과일장수가 현재 소유하고 있는 돈을 변수에 누적 
	}
...
/*
	...
	2. 객체 생성시, 구매자의 현재 소유하고 있는 현금, 사과보유개수를 저장할 생성자 추가
...
//생성자 : alt + shift +s o
	//new FruitrBuyer(10000); 객체 생성시,
	//또는
	//new FruitrBuyer(20000); 객체 생성시,
...
public class Test64 {
	...
	public static void main(String[] args) {
		...
		//과일 구매자 객체 생성과 동시에, 객체 변수의 값을 초기화할 생성자 호출
		//생성자 호출시 과일 구매자의 현재 소유하고 있는 현금 셋팅을 위해 10000원 전달
